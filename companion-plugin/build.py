#!/usr/bin/env python3
"""build.py — Build clipwatch-companion.plugin from source skills.

Usage:
    python3 companion-plugin/build.py

Output:
    companion-plugin/clipwatch-companion.plugin
...
OUT  = HERE / 'clipwatch-companion.plugin'
...
PLUGIN_META = {
    ...
    'description': (
        ...
        'Requires ClipWatch running on this Mac (localhost:57822).'
    ),
